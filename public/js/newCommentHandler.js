  //This is my function that allows users to post comments to blog posts
  ...
  // Event Listener to the form with ID 'comment-form' triggering the newCommentHandler function
  console.log("HERE!");
