// This is my function that allows users to delete blog posts on dashboard page and then redirect them to an updated dashboard
const deletePostHandler = async (event) => {
  ...
  // This section of my code is my function that allows for a user to edit blog posts on dashboard page by redirecting them to the /create/:id page
